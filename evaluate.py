...
from data import  EvalD3Dataset
...
def main(
    ...
    category_dict = {"Industrial_and_Scientific": "industrial and scientific items", "Office_Products": "restaurants", "Toys_and_Games": "toys and games"}
